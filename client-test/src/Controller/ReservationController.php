...
class ReservationController extends Controller
{
    /**
     *
     * @Route("/reservations", name="reservation_liste")
     *
    ...
    public function liste(Request $request)
    {
        ...
        $response = $client->request('GET', 'http://localhost:8001/reservations');
        $hotels = [];
        ...
        return $this->render('reservation/liste.html.twig', ['liste' => $hotels]);
    }

    /**
     *
     * @Route("/hotels/{id}", name="reservation_detail")
     *
     * @param Request $request
     * @return \Symfony\Component\HttpFoundation\Response
     */
    public function detail(Request $request)
    {
        $id = $request->get('id', 0);
        $client = HttpClient::create();
        $response = $client->request('GET', 'http://localhost:8001/reservations/'.$id);
        ...
        return $this->render('reservation/form.html.twig', ['formulaire' => $form->createView(), 'data' =>$hotel]);
    }
     ...
     *
     * @Route("/villes/{id}", name="reservation_save", requirements={"id"="\d+"})
     *
     * @param Request $request
     * @return \Symfony\Component\HttpFoundation\Response
     */
     ...
     *  Ajout hotel
     *
     * @Route("/reservations-ajout", name="reservation_ajout")
     *
     * @param Request $request
     * @return \Symfony\Component\HttpFoundation\Response
     */
     ...
     *  Ajouter Ville
     *
     * @Route("/hotels-supprime/{id}", name="reservation_supprime")
     *
     * @param Request $request
     * @return \Symfony\Component\HttpFoundation\Response
     */
